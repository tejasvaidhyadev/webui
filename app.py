...
app = Flask(__name__)
app.secret_key = 'de4c977ae2545cab6cd35f1ec837c12d'  # Change this to your actual secret key
    ...
    try:
        ...
        if user:
            try:
                ...
                prompt = Prompt(content=request_data['contents'][0]['parts'][0]['text'], user_id=user.id)
